...
class SCNN_1roi_POS_supersmall:
...
class NewPyramidModel_1roi(torch.nn.Module):
    def __init__(self, ):
        ...
        self.conv1 = torch.nn.Conv1d(in_channels, 64, 5, padding=2)
        self.bn1 = torch.nn.BatchNorm1d(64)
        self.act1 = torch.nn.ReLU()

        self.conv1_2 = torch.nn.Conv1d(64, 64, 5, padding=2)
        self.bn1_2 = torch.nn.BatchNorm1d(64)
        self.act1_2 = torch.nn.ReLU()
        

        self.conv2 = torch.nn.Conv1d(64, 64, 5, padding=2)
        self.bn2 = torch.nn.BatchNorm1d(64)
        self.act2 = torch.nn.ReLU()

        self.conv2_2 = torch.nn.Conv1d(64, 64, 3, padding=1)
        self.bn2_2 = torch.nn.BatchNorm1d(64)
        self.act2_2 = torch.nn.ReLU()

        self.conv3 = torch.nn.Conv1d(64, 64, 3, padding=1)
        self.bn3 = torch.nn.BatchNorm1d(64)
        self.act3 = torch.nn.ReLU()

        self.conv3_2 = torch.nn.Conv1d(64, 64, 3, padding=1)
        self.bn3_2 = torch.nn.BatchNorm1d(64)
        self.act3_2 = torch.nn.ReLU()
        
        self.conv4 = torch.nn.Conv1d(64, 64, 3, padding=1)
        self.bn4 = torch.nn.BatchNorm1d(64)
        self.act4 = torch.nn.ReLU()

        self.conv4_2 = torch.nn.Conv1d(64, 64, 3, padding=1)
        self.bn4_2 = torch.nn.BatchNorm1d(64)
        self.act4_2 = torch.nn.ReLU()


        self.conv5 = torch.nn.Conv1d(64, 64, 3, padding=1)
        self.bn5 = torch.nn.BatchNorm1d(64)
        self.act5 = torch.nn.ReLU()

        self.conv6 = torch.nn.Conv1d(64, 64, 3, padding=1)
        self.bn6 = torch.nn.BatchNorm1d(64)
        self.act6 = torch.nn.ReLU()

        
        self.out_conv = torch.nn.Conv1d(64, 1, 1)
